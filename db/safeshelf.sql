...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$720000$xXZFZjL6Lk75BeYWGl9Wwf$pUl78UB6uxmxgjkbQkzSZN8McsAGa006letxrmnm80A=','2024-01-21 22:40:43.590311',1,'adm','','','adm@email.com',1,1,'2024-01-21 22:40:25.710690');
...
INSERT INTO `django_admin_log` VALUES (1,'2024-01-21 22:57:41.362916','1','Arroz 1kg',2,'[{\"changed\": {\"fields\": [\"Tipo\"]}}]',7,1),(2,'2024-01-21 22:58:52.801983','1','Arroz 1kg',2,'[{\"changed\": {\"fields\": [\"Tipo\"]}}]',7,1);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(8,'meuApp','estoque'),(7,'meuApp','produto'),(6,'sessions','session');
...
INSERT INTO `django_session` VALUES ('946hbh8fl3oq1dds0j2nxf2jkf1etqfn','.eJxVjMsOwiAQRf-FtSHQMgVcuvcbmhlmkKqBpI-V8d-1SRe6veec-1IjbmsZt0XmcWJ1VladfjfC9JC6A75jvTWdWl3nifSu6IMu-tpYnpfD_TsouJRvDcY6jmKZfOcggEUw7MPQeYMofe9APFL0WWgQoMBAOSdJxsUIkrN6fwDVUjhy:1rRgUd:XMf4JSbBs4RRtDoqXW0pwKmHVCvDXa0CF41uFxLZkvg','2024-02-04 22:40:43.599451');
...
INSERT INTO `meuapp_estoque` VALUES (1,20,'2024-01-01','2024-02-13',1),(2,15,'2024-01-01','2024-01-28',1),(3,15,'2024-02-13','2024-03-25',1);
...
INSERT INTO `meuapp_produto` VALUES (1,'Arroz 1kg','Alimento','Tio Jorge',6.99),(2,'Feijão','Alimento','Tio João',4.99),(3,'Macarrão','Alimento','Tio Henrique',7.99),(4,'Óleo','Alimento','Sazon',8.99);
...
-- Dump completed on 2024-01-21 20:49:07
